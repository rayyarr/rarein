...
<div class="flex flex-row justify-center py-10">
    <div
        ...
        <a href="#"
            ...
            <div class="col-start-1 text-blue-600 whitespace-nowrap text-4xl font-extrabold my-2">{{ $userdata->total_undangan }}</div>
        ...
        <a href="#"
            ...
            <div class="col-start-1 text-pink-500 whitespace-nowrap text-4xl font-extrabold my-2">{{ $userdata->undangan_dilihat }}</div>
        ...
        <a href="#"
            ...
            <div class="col-start-2 row-span-3 row-start-1 place-self-center justify-self-end text-teal-600">
                <svg fill="none" class="inline-block w-8 h-8 stroke-current stroke-2" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><g transform='translate(2.000000, 2.000000)'><line x1='13.9394' y1='10.413' x2='13.9484' y2='10.413'></line><line x1='9.9304' y1='10.413' x2='9.9394' y2='10.413'></line><line x1='5.9214' y1='10.413' x2='5.9304' y2='10.413'></line><path d='M17.0710351,17.0698449 C14.0159481,20.1263505 9.48959549,20.7867004 5.78630747,19.074012 C5.23960769,18.8538953 1.70113357,19.8338667 0.933341969,19.0669763 C0.165550368,18.2990808 1.14639409,14.7601278 0.926307229,14.213354 C-0.787154393,10.5105699 -0.125888852,5.98259958 2.93020311,2.9270991 C6.83146881,-0.9756997 13.1697694,-0.9756997 17.0710351,2.9270991 C20.9803405,6.8359285 20.9723008,13.1680512 17.0710351,17.0698449 Z'></path></g></svg>
            </div>
            <div class="col-start-1 whitespace-nowrap text-slate-500">Ucapan & Do'a</div>
            <div class="col-start-1 text-teal-600 whitespace-nowrap text-4xl font-extrabold my-2">{{ $userdata->total_ucapan }}</div>
            <div class="col-start-1 text-slate-400 whitespace-nowrap text-xs hidden"></div>
        </a>
