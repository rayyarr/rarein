...
<div id="tabelusers" class="relative overflow-x-auto shadow-md sm:rounded-lg max-w-[900px] w-full justify-center mx-auto">
    ...
    <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 p-4 bg-gray-50">
        <div>
            ...
            <a href="{{ route('tamu.tambah') }}" class="inline-flex items-center ml-2 text-gray-500 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-3 py-1.5">Tambah</a>
            <!-- Dropdown menu -->
        ...
        <div class="relative">
            ...
            <input type="text" name="search" value="{{ request('search') }}" id="table-search-users" class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for users">
        </div>
        </form>
    </div>
    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4">
                    <a href="/tamu/edit/{{ $d->id }}" type="button" data-modal-show="editUserModal" class="font-medium text-blue-600 hover:underline">Ubah</a>
                    <a href="/tamu/hapus/{{ $d->id }}" type="button" data-modal-show="editUserModal" class="ml-2 font-medium text-blue-600 hover:underline">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
